...
type PublicationType = 'news' | 'project' | 'science';
...
const jsonData = publicationsData.map(p => ({
  ...p,
  date: p.date.toISOString()
}));

// Write to file
writeFileSync('data/publications.json', JSON.stringify(jsonData, null, 2));
console.log('✅ JSON file created: data/publications.json');
